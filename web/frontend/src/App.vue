  ...
  <div class="app">
    ...
    <main class="main-content">
      ...
      <div class="content-grid">
        <div class="card">
          <h2>容器列表</h2>
          <div v-if="containers.length" class="list">
            <div v-for="container in containers" :key="container.id" class="list-item">
              <div class="item-name">{{ container.name }}</div>
              <div class="item-status" :class="'status-' + container.status">
                {{ container.status }}
              </div>
            </div>
          </div>
        ...
        <div class="card">
          <h2>镜像列表</h2>
          <div v-if="images.length" class="list">
